            ...
            <div class="row g-5 align-items-center">
                ...
                <c:forEach var="tmp" items="${tmp}">
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <p><i class="fa fa-check text-primary me-3"></i>${tmp.address}</p>
                        <p><i class="fa fa-check text-primary me-3"></i>${tmp.phone}</p>
                        <p><i class="fa fa-check text-primary me-3"></i>${tmp.sect}</p>
