                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                        ...
                                        <c:forEach var="bean" items="${accounts}">
                                            <tr>
                                                ...
                                                <td><img height='100' width='80'
                                                        src="<c:url value='/t6_10_img.controller/${bean.id}' />">
                                                </td>

                                                <td>
                                                    <form action="t6_10_toUpdateAccount.controller/${bean.id}"><a
                                                            class="fa-solid fa-screwdriver-wrench"></a><input
                                                            type="submit" value="修改"></form>&nbsp
                                                    <form action="t6_10_delAccount.controller/${bean.id}"><a
                                                            class="fa-solid fa-trash-can"></a><input type="submit"
                                                            value="刪除"></form>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                ...
                                <div>
                                    <form
                                        action="t6_10_toAddAccount.controller/${accounts.get(accounts.size()-1).getId()+1}">
                                        <input type="submit" value="新增"><a class="fa-solid fa-user-plus"></a></form>
                                    <form action="<c:url value='/index-background.jsp' />"><input type="submit"
                                            value="回首頁"><a class="fa-solid fa-house"></a></form>
                                </div>
                            </div>
                        </div>
                    </div>
