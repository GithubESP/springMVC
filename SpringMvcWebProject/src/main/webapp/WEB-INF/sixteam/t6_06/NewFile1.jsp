					...
					<div class="table-wrapper">
						...
						<table class="alt">
							...
							<c:forEach var="bean" items="${allprodlist}">
								<tbody>
									<tr>
										<td><a href="<c:url value='/_03_product.PathToProductDetail.controller?id=${bean.prodID} '/>"><img height='100' width='80'
											src="<c:url value='/_03_product.showPicture.controller?id=${bean.prodID}' />"></a></td>
