...
//	@PostMapping
//	public ModelAndView save(@RequestParam("name") String name, @RequestParam("img") MultipartFile mf,
...
//			@RequestParam("host") String host,ModelAndView mav) throws IOException {
//		System.out.println("--------------");
//		String fileName = mf.getOriginalFilename();
//		byte[] b = mf.getBytes();
//		if (fileName != null && fileName.length() != 0) {
//		Actives actives = new Actives(id, name, b, description, start, end, location, host);
...
//		return "sixteam/t6_14/mainactive.html";
//	}
//
////讀圖片
...
//@GetMapping("/hello")
//public String hello() {
//    return "sixteam/t6_14/hello"; // 要導入的html
//} }
